        ...
        <div className="flex justify-between items-center gap-4 mb-4">
          ...
          <div className="flex items-center gap-4 w-full max-w-3xl">
            ...
            <input
              ...
              className="flex-grow px-4 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none"
            />
          </div>
        </div>
            ...
            <div className="flex justify-between items-center mt-4">
              ...
              <div>
                ...
                <select
                  ...
                  className="px-2 py-1 border border-gray bg-white text-black rounded-md hover:bg-red-50 focus:outline-none focus:ring"
                >
              ...
              <div className="flex items-center">
                <button
                  ...
                  className={`px-4 py-2 text-white bg-[#b91c1c] rounded-lg hover:bg-red-700 transition ${
